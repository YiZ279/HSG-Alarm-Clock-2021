...
# ## About the Project
# 
# The programme helps HSG students to never run late for university anymore and saves them from the struggles of walking up the hill. Most students who live in the city centre of St. Gallen need to walk to university or take the bus number 5 or 9 from the train station. With regard to convenience, bus number 9 is favoured by most of the students as it stops right next to uni.
# 
...
def setalarm():     
    ...
    if university == 1: 
        ...
        # Bus schedle of Bus 9 from the St. Gallen train station to Univerity (arriving time at university)
        ...
        # Determines the alarm time by deducting the time needed to get ready from the departure of the last bus
